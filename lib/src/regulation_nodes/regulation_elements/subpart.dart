...
class Subpart extends RegulationElement {
  // final List<RegulationNode> parts;

  Subpart(XmlElement element) : super(element);

  factory Subpart.fromXmlElement(XmlElement element) {
    return Subpart(element);
