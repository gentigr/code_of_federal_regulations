...
class Subchapter extends RegulationElement {
  // final List<RegulationNode> parts;

  Subchapter(XmlElement element) : super(element);

  factory Subchapter.fromXmlElement(XmlElement element) {
    return Subchapter(element);
